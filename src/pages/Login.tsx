                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="col-span-1 flex flex-col justify-center w-1/2 ml-28">
                            ...
                            <form onSubmit={onSubmit} className="w-full">
                                ...
                                <div className="flex justify-between items-center mb-4">
                                    <div className="ml-1 text-[#343434]">
                                        ...
                                        <label htmlFor="rememberMe" className='ml-2 font-normal'>Remember me</label>
                                    </div>
                                    <div className="text-[#4B0082]">
                                        <a href="/" className="hover:underline font-normal">Forget Password?</a>
                                    </div>
                                </div>
                        ...
                        <div className="text-center mt-4 mb-12">
                            <p>
                                Are you new to Denaurlen? <Link to="/register" className="text-[#4B0082]">Sign up</Link>
                            </p>
                        </div>
